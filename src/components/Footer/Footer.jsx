    ...
    <footer className="footer">
      <div className="footer__inner">
          ...
          <div className="social-widget">
            <div className="social-row">
              <a href="https://instagram.com/ragequitarcade" target="_blank" rel="noopener noreferrer"
                className="social-card social-card--instagram" aria-label="Instagram"
              ...
              <a href="https://tiktok.com/@ragequitarcade" target="_blank" rel="noopener noreferrer"
                className="social-card social-card--tiktok" aria-label="TikTok"
                onClick={() => social('tiktok')}>
              ...
              <a href="https://facebook.com/ragequitarcade" target="_blank" rel="noopener noreferrer"
                className="social-card social-card--facebook" aria-label="Facebook"
            ...
            <div className="social-row">
              <a href="https://x.com/ragequitarcade" target="_blank" rel="noopener noreferrer"
                className="social-card social-card--x" aria-label="X"
                onClick={() => social('x')}>
              ...
              <a href="https://discord.gg/ragequitarcade" target="_blank" rel="noopener noreferrer"
                className="social-card social-card--discord" aria-label="Discord"
              ...
              <a href="https://reddit.com/r/ragequitarcade" target="_blank" rel="noopener noreferrer"
                className="social-card social-card--reddit" aria-label="Reddit"
        ...
        <div className="footer__col">
          ...
          <Link to="/category/sports" className="footer__link" onClick={() => footerLink('games','sports')}>Sports Games</Link>
          <Link to="/category/arcade" className="footer__link" onClick={() => footerLink('games','arcade')}>Arcade Games</Link>
          <Link to="/leaderboard" className="footer__link" onClick={() => footerLink('games','leaderboard')}>Leaderboard</Link>
        </div>
        <div className="footer__col">
          <span className="footer__col-title">Company</span>
          <Link to="/legal/about" className="footer__link" onClick={() => footerLink('company','about')}>About Us</Link>
          <Link to="/legal/contact" className="footer__link" onClick={() => footerLink('company','contact')}>Contact</Link>
          <Link to="/legal/mentions" className="footer__link" onClick={() => footerLink('company','mentions')}>Legal Notice</Link>
        </div>
        <div className="footer__col">
          <span className="footer__col-title">Legal</span>
          <Link to="/legal/privacy" className="footer__link" onClick={() => footerLink('legal','privacy')}>Privacy Policy</Link>
          <Link to="/legal/terms" className="footer__link" onClick={() => footerLink('legal','terms')}>Terms of Use</Link>
          <Link to="/legal/cookies" className="footer__link" onClick={() => footerLink('legal','cookies')}>Cookie Policy</Link>
        </div>
      </div>
